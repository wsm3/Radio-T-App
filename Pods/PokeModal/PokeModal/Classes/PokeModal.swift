...
open class PokeModal: UIResponder {
    ...
    public init(view: UIView) {
        ...
        containerView = UIView(frame: CGRect(x: 0, y: screenHeight, width: screenWidth
        ...
        titleLabel = UILabel(frame: CGRect(x: (screenWidth - 20) / 2.0 - 80, y: 0, width: 160, height: 40))
        ...
        contentLabel = UILabel(frame: CGRect(x: 10, y: 20, width: screenWidth - 20 - 0, height: (self.containerView?.frame.height)! - 120))
        ...
        closeButton = UIButton(frame: CGRect(x: (screenWidth - 20) / 2.0 - 25, y: self.screenHeight / 2.0 - 80, width: 50, height: 50))
    ...
    open func showMenu() -> Void {
        if isShown == false {
            ...
            if contentLabel != nil {
                ...
                scrollView = UIScrollView(frame: CGRect(x: 10, y: 40, width: screenWidth - 10, height: (self.containerView?.frame.height)! - 120))
            ...
            UIView.animate(withDuration: 0.2, delay: 0.0, options: UIViewAnimationOptions.curveEaseOut, animations: {
                self.containerView?.frame = CGRect(x: 0, y: self.screenHeight / 2.0, width: self.screenWidth, height: self.screenHeight / 2.0)
